...
(function () {
  ...
  if (typeof window != "undefined") {
    ...
    if (dojo.isIE) {
      ...
      try {
        ...
        var _5d = ["*", "group", "roundrect", "oval", "shape", "rect", "imagedata"],
          i = 0,
          l = 1,
  ...
  if (!dojo._hasResource["dojo._base.declare"]) {
    ...
    (function () {
      ...
      d.declare = function (_c8, _c9, _ca) {
        var _cb, i, t, _cc, _cd, _ce, _cf, _d0 = 1,
          _d1 = _c9;
  ...
  if (!dojo._hasResource["dojo._base.event"]) {
    ...
    (function () {
      ...
      dojo._connect = function (obj, _119, _11a, _11b, _11c) {
        ...
        var lid = _11d ? (_11c ? 2 : 1) : 0,
          l = [dojo._listener, del, _118][lid];
  ...
  if (!dojo._hasResource["dojo._base.html"]) {
    ...
    if (dojo.isIE || dojo.isOpera) {
      dojo.byId = function (id, doc) {
        ...
        var _13d = doc || dojo.doc,
          te = _13d.getElementById(id);
      ...
      var _154 = d.isIE ? "styleFloat" : "cssFloat",
        _155 = {
          "cssFloat": _154,
          "styleFloat": _154,
          "float": _154
      ...
      dojo._setMarginBox = function (node, _162, _163, _164, _165, _166) {
        var s = _166 || gcs(node),
          ...
          pb = bb ? _167 : d._getPadBorderExtents(node, s);
        if (d.isWebKit) {
      ...
      d._toDom = function (frag, doc) {
        ...
        frag += "";
        var _18b = frag.match(_185),
          tag = _18b ? _18b[1].toLowerCase() : "",
          _18c = _186[_18a],
          wrap, i, fc, df;
        if (_18b && _184[tag]) {
          wrap = _184[tag];
      ...
      dojo.addClass = function (node, _191) {
        ...
        _191 = _190(_191);
        var cls = " " + node[_18d] + " ";
        for (var i = 0, len = (_191.length==null ? 0 : _191.length), c; i < len; ++i) {
          c = _191[i];
      ...
      dojo.removeClass = function (node, _192) {
        ...
        if (_192 !== undefined) {
          _192 = _190(_192);
          cls = " " + node[_18d] + " ";
          for (var i = 0, len = (_192.length==null ? 0 : _192.length); i < len; ++i) {
  ...
  if (!dojo._hasResource["dojo._base.xhr"]) {
    ...
    (function () {
      ...
      var _23c = _22c._contentHandlers = dojo.contentHandlers = {
        text: function (xhr) {
    ...
    (function () {
      ...
      d.extend(dojo.Animation, {
        ...
        play: function (_266, _267) {
          ...
          var de = _266 || _268.delay,
            _269 = dojo.hitch(_268, "_play", _267);
          if (de > 0) {
      ...
      dojo._fade = function (args) {
        ...
        var _278 = _262({
          ...
          _279 = (_278.properties.opacity = {});
        _279.start = !("start" in _278) ?
        function () {
