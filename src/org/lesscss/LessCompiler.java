...
public class LessCompiler {
    ...
    private void init() {
        ...
        try {
            ...
            if (DebugFile.trace) DebugFile.writeln(message);
            throw new IllegalStateException(message, e);
        }
        
        if (DebugFile.trace) DebugFile.writeln("Finished initialization of LESS compiler in " + (System.currentTimeMillis() - start) + " ms.");
    }
    ...
    public String compile(String input) throws LessException {
        ...
        try {
            ...
            if (DebugFile.trace) DebugFile.writeln("Finished compilation of LESS source in " + (System.currentTimeMillis() - start) + " ms.");
    ...
    public void compile(LessSource input, File output, boolean force) throws IOException, LessException {
        if (force || !output.exists() || output.lastModified() < input.getLastModifiedIncludingImports()) {
            ...
            new FileSystem().writefilestr("file://"+output, data, encoding);
        }
    }
}